<div class="row">
    <div class="span3">
          ...
          <a href="#" class="thumbnail qr-code">
            <img src="<?php echo Helper_Image::instance()->getCachePatch('pets.tags', $pet->tag->qrcode, 'large', $pet->id.'/') ?>" alt="">
          </a>
    </div>
    <div class="span6">
        <form action="" method="post">
            ...
            <div class="buttons">
                <?php if(!$pet->tag->qrcode):?>
                    <a class="btn" href="javascript:void(0)" onclick="pet_code.generateCode('<?php echo $pet->id?>', this)" >Generate QR code</a>
                <?php endif; ?>
            </div>
        </form>
    </div>
